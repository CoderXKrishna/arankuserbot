...
async def yt_search(arank):
    try:
        arank = urllib.parse.quote(arank)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={arank}"
        )
...
"""
async def yt_data(arank):
    params = {"format": "json", "url": arank}
