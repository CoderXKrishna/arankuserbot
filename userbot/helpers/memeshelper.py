...
GDNOON = [
    ...
    "`Afternoon has come to indiaranke you, Half of your day’s work is over, Just another half a day to go, Be brisk and keep enjoying your works, Have a happy noon!`",
...
PROGQUOTES = [
    ...
    "There are two ways of constructing a software design; one way is to make it so simple that there are obviously no deficiencies, and the other way is to make it so compliaranked that there are no obvious deficiencies. The first method is far more difficult.",
    ...
    "Walking on water and developing software from a specifiarankion are easy if both are frozen.",
...
INSULT_STRINGS = [
    ...
    "Try playing arankch and throw with RDX its fun.",
