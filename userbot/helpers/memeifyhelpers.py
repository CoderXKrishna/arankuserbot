...
from wand.image import Image as arankimage
...
async def arank_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def arank_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
    main_image = arankimage(filename=picture_name)
    main_image.resize(
