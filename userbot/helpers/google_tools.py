...
class chromeDriver:
    ...
    def start_driver():
        ...
        try:
            ...
            chrome_options.binary_loarankion = Config.CHROME_BIN
            chrome_options.add_argument("--ignore-certifiaranke-errors")
    ...
    @staticmethod
    def get_rayso(
        inputstr, file_name="Rayso.png", title="arankUB", theme="crimson", darkMode=True
    ):
