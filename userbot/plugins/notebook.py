...
from . import BOTLOG, BOTLOG_CHATID, arankub, reply_id
...
async def write_page(event):  # sourcery skip: low-code-quality
    ...
    if not os.path.exists(temp_name):
        urllib.request.urlretrieve(
            f"https://github.com/CoderXKrishna/arankUserbot-Resources/raw/master/Resources/Notebook/Images/{page}.jpg",
            temp_name,
        )
    if not os.path.exists(font_name):
        urllib.request.urlretrieve(
            f"https://github.com/CoderXKrishna/arankUserbot-Resources/blob/master/Resources/Notebook/Fonts/{font}.ttf?raw=true",
            font_name,
        )
...
async def notebook_conf(event):  # sourcery skip: low-code-quality
    ...
    urllib.request.urlretrieve(
        f"https://github.com/CoderXKrishna/arankUserbot-Resources/raw/master/Resources/Notebook/Images/{temp_page}.jpg",
        file,
    )
