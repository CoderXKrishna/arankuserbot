...
@arankub.arank_cmd(
    ...
    info={
        "header": "To customize your arankUserbot.",
        "options": {
...
async def custom(event):
    "To customize your arankUserbot."
...
@arankub.arank_cmd(
    ...
    info={
        "header": "To delete costomization of your arankUserbot.",
        "options": {
...
async def del_custom(event):
    "To delete costomization of your arankUserbot."
    input_str = event.pattern_match.group(1)
    if input_str == "pmpermit":
