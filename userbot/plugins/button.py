...
from . import arankub, edit_delete, reply_id
...
def inline_button_aricle(method):
    ...
    media = None
    buttons_list = []
    if arankmedia := MEDIA_PATH_REGEX.search(markdown_note):
        media = arankmedia.group(2)
        markdown_note = markdown_note.replace(arankmedia.group(0), "")
...
@arankub.arank_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test <media:downloads/thumb_image.jpg> [google]<buttonurl:https://www.google.com> [arankuserbot]<buttonurl:https://t.me/arankuserbot17:same> [support]<buttonurl:https://t.me/arankuserbot_support>",
    },
)
async def _(event):
...
@arankub.arank_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [arankuserbot]<buttonurl:https://t.me/arankuserbot17:same> [support]<buttonurl:https://t.me/arankuserbot_support>",
    },
)
async def _(event):
