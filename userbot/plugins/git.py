...
async def source(e):
    ...
    await edit_or_reply(
        e,
        "Click [here](https://github.com/CoderXKrishna/arankuserbot) to open this bot source code\
        \nClick [here](https://github.com/CoderXKrishna/nekopack) to open supported link for heroku",
    )
...
async def _(event):
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(URL) as request:
            ...
            arankevent = await edit_or_reply(event, "`fetching github info ...`")
