...
@arankub.arank_cmd(
    ...
    info={
        ...
        "description": "Transfers ownership to the given username for this set this var `TG_2STEP_VERIFIarankION_CODE` in heroku with your 2-step verifiarankion code.",
...
async def _(event):
    ...
    try:
        ...
        my_srp_password = pwd_mod.compute_check(pwd, Config.TG_2STEP_VERIFIarankION_CODE)
        await event.client(
