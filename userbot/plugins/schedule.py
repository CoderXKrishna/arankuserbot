...
@arankub.arank_cmd(
    ...
    info={
        ...
        "examples": [
            "{tr}schedule @arank > 2069-01-30 20:30",
            "{tr}schedule @arank 25465845 -1005554825 > 2069-01-30 20:30",
            "{tr}schedule -b aranklist > 2069-01-30 20:30",
        ],
...
async def schedule(event):
    ...
    try:
        ...
        if "-b" in user:
            ...
            for item in user.split():
                ...
                with contextlib.suppress(ValueError, IndexError):
                    user = await arankub.get_entity(item)
        ...
        logged = await arankub.send_message(BOTLOG_CHATID, reply)
...
@arankub.arank_cmd(
    ...
    info={
        ...
        "examples": [
            "{tr}autoschedule @arank > sunday 20:30",
            "{tr}autoschedule @arank 25465845 -1005554825 > sunday 20:30",
            "{tr}autoschedule -b aranklist > sunday 20:30",
        ],
        "Note": "Set `TZ` in config with your timezone, default it is Asia/Kolkata.",
    },
)
