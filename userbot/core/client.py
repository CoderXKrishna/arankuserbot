...
class arankUserBotClient(TelegramClient):
    def arank_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        link = "[here](https://t.me/Carding_Chronicle)"
                        text = (
                            "**arankUserbot Error report**\n\n"
            ...
            if pattern is not None:
                ...
                if edited:
                    arankub.add_event_handler(func, events.MessageEdited(**kwargs))
                arankub.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited:
                arankub.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                arankub.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
arankUserBotClient.fast_download_file = download_file
arankUserBotClient.fast_upload_file = upload_file
arankUserBotClient.reload = restart_script
arankUserBotClient.get_msg_link = get_message_link
arankUserBotClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    arankUserBotClient.send_message = send_message
    arankUserBotClient.send_file = send_file
    arankUserBotClient.edit_message = edit_message
